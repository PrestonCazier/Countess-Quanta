...
namespace CountessQuantaControl
{
    ...
    /// </summary>
    public partial class SkeletonViewer : Window
    {
        /// <summary>
        ...
        private Point SkeletonPointToScreen(SkeletonPoint skelpoint)
        {
            ...
            DepthImagePoint depthPoint = kinectManager.MapSkeletonPointToDepthPoint(skelpoint, DepthImageFormat.Resolution640x480Fps30);
